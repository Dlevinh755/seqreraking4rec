...
class ClothesDataset(AbstractDataset):
    @classmethod
    def code(cls):
        return 'clothes'
    ...
    @classmethod
    def url(cls):
        return ['http://snap.stanford.edu/data/amazon/productGraph/categoryFiles/ratings_Clothing_Shoes_and_Jewelry.csv',
    ...
    def all_raw_file_names(cls):
        return ['clothes.csv', 'clothes_meta.json.gz']
